...
#
#       python ./download-all-2021-12-16_18-53-34.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2021-12-16_18-53-34.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
class bulk_downloader:
    def __init__(self):
        ...
        with open(r'C:\Users\acmor\Desktop\gits\data\files.txt') as file:
    ...
    def download_file_with_cookiejar(self, url, file_count, total, recursion=False):
       ...
       download_file = os.path.basename(r'C:\Users\acmor\Desktop\hdfs\files'+url).split('?')[0]
